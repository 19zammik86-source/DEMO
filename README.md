...
7.Настраиваем IPSec два скрипта на каждый роутер... запустили и проверили


8. Если нигде не нарукож0пить, то на данный момент будет выполнен почти весь первый модуль и часть второго. Остальное все ручками...
9. PS... отчасти настроена трансляция портов из 3го модуля, можно также попробовать ансибл2
